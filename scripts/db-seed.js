...
const TEMPLATES = {
  electronics: [
    { name: "SuperBass Wireless Headphones", price: 4999 },
    { name: "SmartFit Fitness Band Pro", price: 3499 },
    { name: "ChargeMax Power Bank 20K", price: 2499 },
    { name: "UltraClean Sonic Electric Toothbrush", price: 3999 },
    { name: "SoundWave Bluetooth Speaker", price: 2999 },
    { name: "OptiView LED Desk Lamp", price: 1699 },
    { name: "FastCharge Wireless Charging Pad", price: 1299 },
    { name: "ClearCall TWS Earbuds", price: 2299 },
    { name: "SpeedClick Wireless Gaming Mouse", price: 1899 },
    { name: "AeroCool Laptop Cooling Pad", price: 1599 }
  ],
  fashion: [
    { name: "Classic Cotton Polo T-Shirt", price: 1499 },
    { name: "Vintage Aviator Sunglasses", price: 1299 },
    { name: "ActiveWear Breathable Sports Shoes", price: 3999 },
    { name: "SlimFit Stretch Denim Jeans", price: 2499 },
    { name: "Elegant Leather Chronograph Watch", price: 7999 },
    { name: "Handcrafted Leather Wallet", price: 999 },
    { name: "Cozy Cotton Knit Sweater", price: 2799 },
    { name: "Casual Canvas Sneakers", price: 1999 },
    { name: "Compact Travel Backpack", price: 1699 },
    { name: "Warm Woolen Winter Scarf", price: 899 }
  ],
  home: [
    { name: "Ergonomic Memory Foam Pillow", price: 1999 },
    { name: "Stainless Steel Water Bottle", price: 999 },
    { name: "Non-Stick Ceramic Frying Pan", price: 2499 },
    { name: "Aroma Diffuser with Essential Oils", price: 1599 },
    { name: "Premium Cotton Bed Sheet Set", price: 3299 },
    { name: "Compact Espresso Coffee Maker", price: 6999 },
    { name: "Smart WiFi LED Light Bulb", price: 799 },
    { name: "Handwoven Bamboo Laundry Basket", price: 1299 },
    { name: "Digital Kitchen Weighing Scale", price: 899 },
    { name: "Automatic Liquid Soap Dispenser", price: 1199 }
  ],
  sports: [
    { name: "Non-Slip Eco Yoga Mat", price: 1699 },
    { name: "Heavy Duty Resistance Bands Set", price: 999 },
    { name: "UltraLite Camping Hammock", price: 1999 },
    { name: "Waterproof Hiking Backpack 40L", price: 3299 },
    { name: "High-Bounce Tennis Balls Pack", price: 499 },
    { name: "Adjustable Skipping Jump Rope", price: 399 },
    { name: "Insulated Sports Squeeze Bottle", price: 699 },
    { name: "Neoprene Dumbbells Set (2x2kg)", price: 1499 },
    { name: "Anti-Glare Cycling Sunglasses", price: 1199 },
    { name: "Professional Leather Soccer Ball", price: 1899 }
  ],
  beauty: [
    { name: "Organic Aloe Vera Gel", price: 499 },
    { name: "Hydrating Hyaluronic Acid Serum", price: 1299 },
    { name: "Natural Herbal Shampoo & Conditioner", price: 999 },
    { name: "Exfoliating Scrub Face Wash", price: 449 },
    { name: "Shea Butter Body Lotion", price: 799 },
    { name: "Matte Finish Liquid Lipstick", price: 899 },
    { name: "Organic Coconut Hair Oil", price: 599 },
    { name: "Soothing Lavender Bath Salts", price: 799 },
    { name: "Sunscreen SPF 50+ Broad Spectrum", price: 999 },
    { name: "Rose Water Facial Toner Spray", price: 399 }
  ],
  grocery: [
    { name: "Premium Darjeeling Tea Bags", price: 499 },
    { name: "Organic Raw Forest Honey", price: 799 },
    { name: "Handpicked Premium Cashews Pack", price: 1299 },
    { name: "Spicy Garlic Chilli Oil", price: 399 },
    { name: "Gourmet Dark Chocolate Bar 70%", price: 349 },
    { name: "Organic Whole Wheat Pasta", price: 299 },
    { name: "Extra Virgin Olive Oil 500ml", price: 999 },
    { name: "Traditional Basmati Rice (1kg)", price: 249 },
    { name: "Roasted Salted Almonds Pack", price: 1199 },
    { name: "Assorted Indian Spices Gift Box", price: 1499 }
  ],
  books: [
    { name: "Hardcover Executive Dotted Journal", price: 699 },
    { name: "Fine Tip Gel Pens Multi-Color Set", price: 499 },
    { name: "Weekly Planner Organizer Notepad", price: 599 },
    { name: "Stainless Steel Premium Fountain Pen", price: 1699 },
    { name: "Sticky Notes and Page Flags Set", price: 349 },
    { name: "Metal Desk Organizer Pen Stand", price: 449 },
    { name: "Sketchbook for Drawing (A4 Size)", price: 699 },
    { name: "Dual-Tip Art Markers 24 Colors", price: 1299 },
    { name: "Erasable Whiteboard Markers Pack", price: 399 },
    { name: "Minimalist Wooden Bookends Set", price: 899 }
  ],
  toys: [
    { name: "Wooden Educational Building Blocks", price: 1699 },
    { name: "3D Mechanical Wooden Puzzle Kit", price: 1999 },
    { name: "Classic Board Game Strategy Set", price: 1199 },
    { name: "DIY Science Experiment Kit for Kids", price: 1499 },
    { name: "Remote Control Stunt Car Toy", price: 2499 },
    { name: "Soft Plush Teddy Bear (Medium)", price: 999 },
    { name: "Watercolor Painting Kit for Beginners", price: 899 },
    { name: "Memory Match Card Game for Kids", price: 499 },
    { name: "Outdoor Bubble Blower Machine", price: 1199 },
    { name: "Interactive Talking Alphabet Poster", price: 1299 }
  ],
  auto: [
    { name: "Universal Car Mobile Phone Mount", price: 799 },
    { name: "Dual USB Car Charger Adapter", price: 599 },
    { name: "Premium Microfiber Car Cleaning Cloths", price: 699 },
    { name: "Portable Digital Car Tire Inflator", price: 2499 },
    { name: "Car Dashboard Gel Air Freshener", price: 349 },
    { name: "Anti-Fog Side Mirror Protective Film", price: 299 },
    { name: "Ergonomic Car Seat Lumbar Support Pillow", price: 1499 },
    { name: "Compact Car Trash Can with Lid", price: 499 },
    { name: "Heavy Duty Jumper Cables 10ft", price: 1299 },
    { name: "Waterproof Cargo Trunk Organizer", price: 1699 }
  ],
  health: [
    { name: "Premium Whey Protein Powder (1kg)", price: 3499 },
    { name: "Daily Multivitamin Capsules (90 pcs)", price: 1299 },
    { name: "Cold Pressed Omega-3 Fish Oil", price: 999 },
    { name: "Digital Body Weight Scale", price: 1499 },
    { name: "Acupressure Foot Massage Roller", price: 599 },
    { name: "Natural Herbal Green Tea Leaves", price: 399 },
    { name: "Fast Relief Muscle Massage Gun", price: 3999 },
    { name: "Orthopedic Knee Support Sleeve", price: 799 },
    { name: "Air Purifying Himalayan Salt Lamp", price: 1899 },
    { name: "Essential Vitamin D3 Softgels", price: 699 }
  ]
};
  ...
  for (const state of STATES) {
    ...
    for (const cat of CATEGORIES) {
      ...
      for (let i = 0; i < templates.length; i++) {
        ...
        const desc = `Premium ${template.name} designed with high-quality materials and exceptional craftsmanship. Perfect for your daily lifestyle and needs.`;
        const tags = [
